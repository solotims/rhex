...
this->model->GetJoint("link_0_JOINT_1")->SetVelocity(0, true1);
this->model->GetJoint("link_0_JOINT_2")->SetVelocity(0, true2);
this->model->GetJoint("link_0_JOINT_3")->SetVelocity(0, true1);
this->model->GetJoint("link_0_JOINT_4")->SetVelocity(0, -true2);
this->model->GetJoint("link_0_JOINT_5")->SetVelocity(0, -true1);
this->model->GetJoint("link_0_JOINT_6")->SetVelocity(0, -true2);
